...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>E-LEARNING SOLUTIONS</h3>
                </a>
    ...
    <a href="#" class="nav-link dropdown-toggle" id="apartmentDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        <i class="fa fa-laptop me-2"></i>Communcation Skills
    </a>
    <ul class="dropdown-menu" aria-labelledby="apartmentDropdown">
        <li><a class="dropdown-item" href="{{ route('communication.create') }}">Add communication</a></li>
        <li><a class="dropdown-item" href="{{ route('communication.index') }}">View communications</a></li>
    </ul>
</div>

                 <div class="nav-item dropdown">
    <a href="#" class="nav-link dropdown-toggle" id="apartmentDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        <i class="fa fa-laptop me-2"></i>C Programming
    </a>
    <ul class="dropdown-menu" aria-labelledby="apartmentDropdown">
        <li><a class="dropdown-item" href="{{ route('cprogramming.create') }}">Add C Programming</a></li>
        <li><a class="dropdown-item" href="{{ route('cprogramming.index') }}">View C Programming</a></li>
    </ul>
</div>

               <div class="nav-item dropdown">
    <a href="#" class="nav-link dropdown-toggle" id="apartmentDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        <i class="fa fa-laptop me-2"></i>Political Economy
    </a>
    <ul class="dropdown-menu" aria-labelledby="apartmentDropdown">
        <li><a class="dropdown-item" href="{{ route('political.create') }}">Add Political Economy</a></li>
        <li><a class="dropdown-item" href="{{ route('political.index') }}">View Political Economy</a></li>
    </ul>
</div>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="{{asset('assetz/img/user.jpg')}}" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Young leaders... sent you a message</h6>
                   ...
                   <div class="nav-item dropdown">
    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
        <img class="rounded-circle me-lg-2" src="{{ asset('assetz/.jpg') }}" alt="" style="width: 40px; height: 40px;">
        <span class="d-none d-lg-inline-flex">AJ TECH</span>
    </a>
    <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
